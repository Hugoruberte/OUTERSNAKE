...
namespace SaveGameFree
{
	...
	public static class Saver
	{
		...
		/// </summary>
		/// <param name="obj">Object.</param>
		/// <param name="fileName">File name. (myFileName, playerData, data)</param>
		/// <param name="savePath">Save path.</param>
		...
		/// <param name="fileName">File name.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public static GameData LoadGame (string fileName)// where T : new()
		{
			...
			obj = Serializer.Deserialize<GameData> ( filePath );
			if ( obj == null )
				obj = new GameData ();
			if ( OnLoaded != null )
				OnLoaded ( obj );
		...
		/// <param name="fileName">File name.</param>
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		public static PlayerData LoadPlayer (string fileName)// where T : new()
		{
			...
			obj = Serializer.Deserialize<PlayerData> ( filePath );
			if ( obj == null )
				obj = new PlayerData ();
			if ( OnLoaded != null )
				OnLoaded ( obj );
