...
{
	public RabbitEntity rabbit { get; private set; }
	...
	public override IEnumerator Rest()
	{
		...
		duration = Random.Range(this.rabbit.rabbitData.afterJumpTempoInterval[0], this.rabbit.rabbitData.afterJumpTempoInterval[1]);
